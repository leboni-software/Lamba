...
{
    public class UserReaderRepository(IdentityReaderDbContext dbContext) : BaseReaderRepository<User, Guid, IdentityReaderDbContext>(dbContext), IUserReaderRepository
    {
    }
}
