...
{
    public class UserWriterRepository(IdentityWriterDbContext dbContext) : BaseWriterRepository<User, Guid, IdentityWriterDbContext>(dbContext), IUserWriterRepository
    {
    }
}
